...
-- If a buffer is a terminal, disable line numbers
vim.api.nvim_create_autocmd('TermOpen', {
  desc = 'Disable line numbers on terminal open',
  group = vim.api.nvim_create_augroup('kickstart-disable-term-line-numbers', { clear = true }),
  callback = function()
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>su', extensions.undo.undo, { desc = '[S]earch [U]ndotree' })
    ...
    config = function(_, opts)
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Same as gd, but opens the definition in a new buffer
          map('gD', function()
            vim.cmd 'vsplit'
            require('telescope.builtin').lsp_definitions()
          end, '[G]oto [D]efinition in right split')
